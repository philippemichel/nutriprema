...
Une analyse factorielle (package `Fact   
oMineR` [@facto] & `factoextra` [@fextra]) sera tentée (Analyse en Correspondances Multiples) avec classification des cas si possible après imputation des données manquantes (package `MissMDA` [@missm]) .
